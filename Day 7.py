...
FREQ_TO_NOTE = {
    ...
    1046.50: "C6", 1174.66: "D6", 1318.51: "E6", 1396.91: "F6", 1567.98: "G6", 1760.00: "A6", 1975.53: "B6", 2093.00: "C7",
}
...
def draw_keyboard_hint(surface):
    ...
    # TODO: Add top row keys and labels (Q-P) for even higher notes!
    top_row_keys = "QWERTYUI"
    top_row_notes = ["C6", "D6", "E6", "F6", "G6", "A6", "B6", "C7"]
    x_start3 = x_start2 + len(middle_keys) * (key_size + gap) + 30
    label3 = FONT.render("Higher:", True, TEXT_COLOR)
    surface.blit(label3, (x_start3 - 70, y_start + 8))
    for i, (key_char, note) in enumerate(zip(top_row_keys, top_row_notes)):
